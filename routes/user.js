...
try {
  route.get("/api/viewAllPost", (req, res) => {});
} catch (err) {}
...
try {
  route.get("/api/viewYourPost/:email",(req, res) => {
...
try {
  route.post("/api/addPost", (req, res) => {
...
try {
  route.delete("/api/deletePost/:id", (req, res) => {
...
try {
  route.put("/api/updatePost/:id", (req, res) => {
    let id = req.params.id;
    console.log(req.body);
    console.log(id);
